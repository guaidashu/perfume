        ...
        <div class="container">
            <div class="checkout-order">
                <div class="page-title-normal">
                    <h2 class="page-title-h2"><span>查看 订单</span></h2>
                </div>
                <!-- process step -->
                        ...
                        <ul class="cart-item-list">
                            <li v-for="(item, index) in cartList" :key="index" v-if="parseInt(item.checked) === 1">
                                ...
                                <div class="cart-tab-4">
                                    <div class="item-price-total">{{getLittleTotalPrice(item) | currency('￥')}}</div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    import {cartList, payMent} from "../../api/user";
    ...
    export default {
        ...
        computed: {
            totalPrice() {
                return this.getTotalPrice() + this.shipping + this.discount + this.tax
            }
        },
        data() {
            return {
