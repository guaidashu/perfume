                            ...
                            <ul class="cart-item-list">
                                <li v-for="(item, index) in cartList" :key="index">
                                    ...
                                    <div class="cart-tab-4">
                                        <div class="item-price-total">{{getLittleTotalPrice(item) | currency('￥')}}
                                        </div>
                                    </div>
                        ...
                        <div class="cart-foot-inner">
                            ...
                            <div class="cart-foot-r">
                                <div class="item-total">
                                    总计： <span class="total-price">{{getTotalPrice() | currency('￥')}}</span>
                                </div>
                                <div class="btn-wrap">
                                    <a href="javascript:;" class="btn btn--red" :class="{'btn--dis': goodsNum === 0}" @click="checkOut">结账</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    import {cartEdit, cartList, delCart, editCheckAll} from "../../api/user";
